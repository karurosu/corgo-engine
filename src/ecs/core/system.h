...
typedef enum CE_ECS_SYSTEM_RUN_ORDER {
    ...
    CE_ECS_SYSTEM_RUN_ORDER_RENDER = 2,
    CE_ECS_SYSTEM_RUN_ORDER_COUNT = 3,
...
typedef enum CE_ECS_SYSTEM_RUN_PHASE {
    ...
    CE_ECS_SYSTEM_RUN_PHASE_DEBUG = 3,
...
typedef enum CE_ECS_SYSTEM_RUN_FREQUENCY {
    ...
    CE_ECS_SYSTEM_RUN_FREQUENCY_HALF_DISPLAY_ODD = 2,
    CE_ECS_SYSTEM_RUN_FREQUENCY_ONCE_PER_SECOND = 3,
    CE_ECS_SYSTEM_RUN_FREQUENCY_COUNT = 4,
