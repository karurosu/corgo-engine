...
#define CE_SYSTEM_DESC_CORE(X) \
	X(CE_CORE_DEBUG_SYSTEM, CE_ECS_SYSTEM_RUN_ORDER_AUTO, CE_ECS_SYSTEM_RUN_PHASE_LAST, CE_ECS_SYSTEM_RUN_FREQUENCY_ONCE_PER_SECOND, CE_CORE_DEBUG_SYSTEM_DEPENDENCIES)
