...
#define CE_SYSTEM_TEST_CORE(X) \
    ...
    X(CE_CORE_TEST_SYSTEM_SCENE_ORDER, CE_ECS_SYSTEM_RUN_ORDER_SCENETREE, CE_ECS_SYSTEM_RUN_PHASE_DEFAULT, CE_ECS_SYSTEM_RUN_FREQUENCY_DISPLAY, CE_CORE_TEST_SYSTEM_DEPENDENCIES)
#else 
#define CE_SYSTEM_TEST_CORE(X)
...
#define CE_SYSTEM_DESC_CORE(X) \
    ...
    X(CE_CORE_ENTITY_DEBUG_SYSTEM, CE_ECS_SYSTEM_RUN_ORDER_AUTO, CE_ECS_SYSTEM_RUN_PHASE_LATE, CE_ECS_SYSTEM_RUN_FREQUENCY_HALF_DISPLAY, CE_CORE_DEBUG_SYSTEM_DEPENDENCIES)
...
#define CE_GLOBAL_SYSTEM_DESC_CORE(X) \
    X(CE_CORE_GLOBAL_DEBUG_SYSTEM, CE_ECS_SYSTEM_RUN_PHASE_LATE, CE_ECS_SYSTEM_RUN_FREQUENCY_ONCE_PER_SECOND)
