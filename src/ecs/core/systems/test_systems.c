...
CE_START_SYSTEM_IMPLEMENTATION(CE_CORE_TEST_SYSTEM_DISPLAY, CE_CORE_TEST_SYSTEM_DEPENDENCIES)
{
...
CE_START_SYSTEM_IMPLEMENTATION(CE_CORE_TEST_SYSTEM_HALF_DISPLAY, CE_CORE_TEST_SYSTEM_DEPENDENCIES)
{
...
CE_START_SYSTEM_IMPLEMENTATION(CE_CORE_TEST_SYSTEM_SECOND, CE_CORE_TEST_SYSTEM_DEPENDENCIES)
{
